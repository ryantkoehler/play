...
OUT_FNAME = "OUTPUT/categories-v2-io.txt"
...
def main():
    ...
    # Get list of category info; infile2 col 3
    cat_list = io_utils.get_data_file_col(args.infile2, col=3, sep='\t')
    print(f"Loaded {len(cat_list)} rows from {args.infile2}")

    # Use dict for category counts
    category_counts = {}
    # Skip first list item as this is from header
